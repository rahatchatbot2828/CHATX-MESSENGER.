...
const backgroundImages = [
    "https://i.imgur.com/34Xsirh.jpeg",
    "https://files.catbox.moe/bjdbgv.png",
    "https://files.catbox.moe/lo2gel.png",
    "https://files.catbox.moe/ynacrg.png",
    "https://files.catbox.moe/zznwx1.png",
    "https://files.catbox.moe/9dzk5l.png"
];
...
async function createWelcomeCard(gcImg, userImg, adderImg, userName, userNumber, threadName, adderName) {
    ...
    await Promise.all([
        drawProfileImage(ctx, gcImg, width / 2, 200, 140, "#ffffff"),
    
        drawProfileImage(ctx, userImg, 120, height - 100, 70, "#10b981"),
    
        drawProfileImage(ctx, adderImg, width - 120, 100, 70, "#3b82f6")
    ]);

    ctx.font = 'bold 36px "Segoe UI", Arial';
    ctx.fillStyle = "#fff";
    ctx.textAlign = "center";
    ctx.fillText(threadName, width / 2, 310);
    ...
    ctx.fillText("WELCOME", width / 2, 400);
    ...
    ctx.fillText(userName, width / 2, 480);

    ctx.font = 'bold 28px "Segoe UI", Arial';
    ctx.fillStyle = "#e2e8f0";
    ctx.fillText(`Member #${userNumber}`, width / 2, 540);
    ...
    ctx.fillText(`Added by: ${adderName}`, width - 190, 105);
